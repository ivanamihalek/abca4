...
def table_creator(cursor, workbook, xlsx_format):
	...
	header = ["pubmed", "reference", "patient",
	          "allele 1: cdna", "allele 1: protein", "a1: frequency", "a1: homozygotes", "a1: region",
	          "allele 2: cdna", "allele 2: protein", "a2: frequency", "a2: homozygotes", "a2: region",
	...
	for case in hard_landing_search(cursor, qry):
		...
		cdna1, prot1, freqs1, homozygs1, region1 = variants_from_allele(cursor, allele_id_1)
		cdna2, prot2, freqs2, homozygs2, region2 = variants_from_allele(cursor, allele_id_2)
		row += 1
		column = 0
		...
		for content in [patient_xref_id, cdna1, prot1, freqs1, homozygs1, region1,
		                cdna2, prot2, freqs2, homozygs2, region2, onset_age, progression]:
